...
//    val hls_url = "https://devstreaming-cdn.apple.com/videos/streaming/examples/img_bipbop_adv_example_fmp4/master.m3u8"
    ...
    val drm_url = "https://storage.googleapis.com/wvmedia/cenc/h264/tears/tears.mpd"
    val drm_licence="https://proxy.uat.widevine.com/proxy?provider=widevine_test"

    val subtitle_url = "https://storage.googleapis.com/exoplayer-test-media-1/webvtt/numeric-lines.vtt"
